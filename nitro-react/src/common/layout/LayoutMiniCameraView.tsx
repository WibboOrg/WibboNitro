...
import { GetRoomEngine, PlaySound, SoundNames } from '../../api';
        ...
        <DraggableWindow handleSelector=".nitro-room-thumbnail-camera">
            <div className="nitro-room-thumbnail-camera px-2">
                ...
                <div className="d-flex align-items-end h-100 pb-2">
                    <button className="btn btn-sm btn-danger w-100 mb-1 me-2" onClick={ onClose }><FaTimes /></button>
                    <button className="btn btn-sm btn-success w-100 mb-1" onClick={ takePicture }><FaSave /></button>
                </div>
            </div>
        </DraggableWindow>
    );
