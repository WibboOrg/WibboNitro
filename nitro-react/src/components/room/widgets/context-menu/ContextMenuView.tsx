...
export const ContextMenuView: FC<ContextMenuViewProps> = props =>
{
    ...
    useEffect(() =>
    {
        ...
        const update = (time: number) =>
        {
            ...
            const bounds = GetRoomObjectBounds(GetRoomSession()?.roomId ?? 0, objectId, category);
            const location = GetRoomObjectScreenLocation(GetRoomSession()?.roomId ?? 0, objectId, category);
    ...
    useEffect(() =>
    {
        ...
        const timeout = window.setTimeout(() => setIsFading(true), FADE_DELAY);
