...
import { Column, Flex, LayoutAvatarBannerView, LayoutBadgeImageView, Text, UserProfileIconView } from '../../../../../common';
    ...
    return (
        <Column className="rounded nitro-infostand">
            <Column overflow="visible" className="container-fluid content-area" gap={ 1 }>
                ...
                <Column gap={ 1 }>
                    <Flex gap={ 1 }>
                        <Column fullWidth alignItems="center" justifyContent="center">
                            <Flex className="body-image" onClick={ event => GetUserProfile(avatarInfo.webID) }>
                                <LayoutAvatarBannerView banner={ banner } figure={ avatarInfo.figure } direction={ 4 } />
                            </Flex>
                            { avatarInfo.groupId > 0 && <Flex center pointer={ (avatarInfo.groupId > 0) } className="badge-image" onClick={ event => GetGroupInformation(avatarInfo.groupId) }>
