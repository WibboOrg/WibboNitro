...
export const InfoStandWidgetFurniView: FC<InfoStandWidgetFurniViewProps> = props =>
{
    ...
    useEffect(() =>
    {
        ...
        if(isValidController || avatarInfo.isOwner || avatarInfo.isRoomOwner || avatarInfo.isAnyRoomController)
        {
            ...
            if(avatarInfo.roomControllerLevel >= RoomControllerLevel.GUEST) godMode = true;
        }
                ...
                <Column overflow="visible" className="container-fluid content-area" gap={ 1 }>
                    ...
                    <Column gap={ 1 }>
                        <Flex position="relative" gap={ 1 }>
                            ...
                            { (!avatarInfo.stuffData.isUnique && avatarInfo.stuffData.rarityLevel > -1) &&
                                <div className="position-absolute end-0">
                    ...
                    <Column gap={ 1 }>
                        { (avatarInfo.stuffData.rarityLevel > -1) && <Flex alignItems="center" gap={ 1 }>
                            <LayoutRarityLevelView level={ avatarInfo.stuffData.rarityLevel } />
                            <Text variant="white" small wrap>
                                { LocalizeText('rarity.level.' + avatarInfo.stuffData.rarityLevel) }
                            </Text>
                        </Flex> }
                        { (avatarInfo.stuffData.amount > -1) && <Flex alignItems="center" gap={ 1 }>
                            <FaChartLine className="fa-icon w-12 h-12" />
                            <Text variant="white" small wrap>
                                { LocalizeText('furni.amount', [ 'amount' ], [ avatarInfo.stuffData.amount.toString() ]) }
                            </Text>
                        </Flex> }
