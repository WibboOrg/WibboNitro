...
export const WidgetContainerView: FC<WidgetContainerViewProps> = props =>
{
    ...
    const getOption = (key: string) =>
    {
  	...
  	return (
        <div className="widgetcontainer widget d-flex flex-row overflow-hidden mb-2">
            ...
            <div className="d-flex flex-column align-self-center">
                ...
                <button className="btn btn-sm btn-gainsboro align-self-start px-3 mt-2 w-100" onClick={ event => OpenUrl(getOption('btnLink')) }>{ LocalizeText(`landing.view.${ getOption('texts') }.button`) }</button>
            </div>
        </div>
  	);
}
