import { DeleteFurniTypeInventoryComposer, IRoomSession, RoomObjectVariable, RoomPreviewer, Vector3d } from '@nitrots/nitro-renderer';
import { FC, useEffect, useState } from 'react';
import { FaTrashAlt } from 'react-icons/fa';
import { DispatchUiEvent, FurniCategory, GetRoomEngine, GetSessionDataManager, GroupItem, LocalizeText, SendMessageComposer, UnseenItemCategory, attemptItemPlacement } from '../../../../api';
...
export const InventoryFurnitureView: FC<InventoryFurnitureViewProps> = props =>
{
    ...
    const deleteItem = (item: GroupItem) =>
    {
        showConfirm(LocalizeText('inventory.confirm.delete.item', [ 'name' ], [ item.name ]), () =>
        {
        ...
        <Grid>
            ...
            <Column size={ 5 } overflow="auto">
                <Column overflow="hidden" position="relative">
                    ...
                    <Button variant="danger" className="bottom-2 end-2" position="absolute" onClick={ event => deleteItem(selectedItem) }>
                    ...
                    { (selectedItem && !selectedItem.stuffData.isUnique && selectedItem.stuffData.rarityLevel > -1) &&
