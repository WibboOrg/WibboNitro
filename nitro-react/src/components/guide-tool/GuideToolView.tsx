...
export const GuideToolView: FC<{}> = props =>
{
    ...
    const processAction = useCallback((action: string) =>
    {
        switch(action)
        {
            case 'close':
                ...
                return;
            case 'toggle_duty':
                if(!isHandlingBullyReports && !isHandlingGuideRequests && !isHandlingHelpRequests && !isOnDuty)
                {
    ...
    }, [ isHandlingBullyReports, isHandlingGuideRequests, isHandlingHelpRequests, simpleAlert, isOnDuty ]);
