...
export const CameraWidgetShowPhotoView: FC<CameraWidgetShowPhotoViewProps> = props =>
{
    ...
    return (
        <Grid style={ { display: 'flex', flexDirection: 'column' } }>
            <Flex center className="picture-preview border border-black" style={ currentImage.w ? { backgroundImage: 'url(' + GetConfiguration<string>('cdn.url') + currentImage.w + ')' } : {} }>
                { !currentImage.w &&
            ...
            <Flex alignItems="center" justifyContent="between">
                ...
                <Text>{ new Date(currentImage.t * 1).toLocaleDateString() }</Text>
            </Flex>
