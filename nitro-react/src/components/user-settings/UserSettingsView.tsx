        ...
        <NitroCardView uniqueKey="user-settings" className="user-settings-window" theme="primary-slim">
            ...
            <NitroCardContentView className="text-black">
                <Column gap={ 1 }>
                    ...
                    <Flex alignItems="center" gap={ 1 }>
                        <input className="form-check-input" type="checkbox" checked={ disableGameAlert } onChange={ event => setDisableGameAlert(event.target.checked) } />
                        <Text>{ LocalizeText('memunu.settings.disable.game.alert') }</Text>
                    </Flex>
                </Column>
                <Column>
