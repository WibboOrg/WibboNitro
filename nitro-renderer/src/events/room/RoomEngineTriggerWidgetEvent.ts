...
export class RoomEngineTriggerWidgetEvent extends RoomEngineObjectEvent
{
    ...
    public static REQUEST_BADGE_TROC: string = 'RETWE_REQUEST_BADGE_TROC';
    public static REQUEST_BANNER_TROC: string = 'RETWE_REQUEST_BANNER_TROC';
    ...
    public static REQUEST_TWITCH_STREAM_DISPLAY: string = 'RETWE_REQUEST_TWITCH_STREAM_DISPLAY';
    public static REQUEST_HIDE_TWITCH_STREAM_DISPLAY: string = 'RETWE_REQUEST_HIDE_TWITCH_STREAM_DISPLAY';
