    ...
    public getLogicType(type: string): typeof RoomObjectLogicBase
    {
        ...
        switch(type)
        {
            ...
            case RoomObjectLogicType.FURNITURE_BADGE_DISPLAY:
                ...
                break;
            case RoomObjectLogicType.FURNITURE_BADGE_TROC:
                logic = FurnitureBadgeTrocLogic;
                break;
            case RoomObjectLogicType.FURNITURE_BANNER_TROC:
                logic = FurnitureBannerTrocLogic;
                break;
            ...
            case RoomObjectLogicType.FURNITURE_HABBOWHEEL:
                ...
                break;
            case RoomObjectLogicType.FURNITURE_TWITCH_STREAM:
                logic = FurnitureTwitchStreamLogic;
                break;
            default:
                logic = FurnitureLogic;
                break;
